...
export interface ApiCareerPageCareerPage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    footer_links: Schema.Attribute.Component<'shared.footer-links', true>;
    intro_text: Schema.Attribute.String;
    job_listings: Schema.Attribute.Component<'shared.job-listings', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiRichTextPageRichTextPage
  extends Struct.CollectionTypeSchema {
  collectionName: 'rich_text_pages';
  info: {
    displayName: 'rich_text_page';
    pluralName: 'rich-text-pages';
    singularName: 'rich-text-page';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::rich-text-page.rich-text-page'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID;
...
export interface ApiUserType1PageUserType1Page
  extends Struct.CollectionTypeSchema {
  collectionName: 'user_type_1_pages';
  info: {
    description: '';
    displayName: 'user_type_1_page';
    pluralName: 'user-type-1-pages';
    singularName: 'user-type-1-page';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::user-type-1-page.user-type-1-page'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiUserType2PageUserType2Page
  extends Struct.CollectionTypeSchema {
  collectionName: 'user_type_2_pages';
  info: {
    description: '';
    displayName: 'user_type_2_page ';
    pluralName: 'user-type-2-pages';
    singularName: 'user-type-2-page';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::user-type-2-page.user-type-2-page'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    team: Schema.Attribute.Component<'shared.team', true>;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::rich-text-page.rich-text-page': ApiRichTextPageRichTextPage;
      'api::user-type-1-page.user-type-1-page': ApiUserType1PageUserType1Page;
      'api::user-type-2-page.user-type-2-page': ApiUserType2PageUserType2Page;
